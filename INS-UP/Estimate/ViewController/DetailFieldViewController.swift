...
class DetailFieldViewController: UIViewController {
    ...
    @IBAction func nextButtonClicked(_ sender: Any) {
        guard let vc = storyboard?.instantiateViewController(withIdentifier: "ExistProjectViewController") as? ExistProjectViewController else { return }
    ...
    override func viewDidLoad() {
        ...
        selectLabel.font = UIFont.MGothic(type: .r, size: 20)
        ...
        radio4Label.font = UIFont.MGothic(type: .r, size: 16)
